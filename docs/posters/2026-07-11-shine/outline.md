...
Authors: Keheng Zhu, Xianyu Liu, Igor Sokolov, Lulu Zhao
...
Poster: make a poster for my SHINE conference.
refer to the previous AGU poster (/Users/zkeheng/Documents/UM暑研/AGU2024/Poster/AGU-poster-Keheng-draft4.pdf). add progress and update any change.
refer to the writeup and code and visualization and output dir for any information.
I need to clearly state the numerical schemes. be concise. do not use electron beam evaporation. use only gentle evaporation.
may use materials (images and theme and equations and all) from the poster.
use latex to create the poster.