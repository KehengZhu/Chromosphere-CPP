...
- `docs/top_ripple_face_flux_diagnosis.md` — this document
...
Modified: [chromosphere.hpp](chromosphere.hpp) (`GammaFaceFluxCapture`, `capture_face_flux`), [src/rhs.cpp](src/rhs.cpp) (`capture_gamma_face_flux` + one guarded call), [chromo_main.cpp](chromo_main.cpp) (`CHROMO_FACE_FLUX_*` sidecar), [scenarios/model_column.cpp](scenarios/model_column.cpp) (`ISO_LIMITER` diagnostic override), [tests/chromo_tests.cpp](tests/chromo_tests.cpp), [visualize_commands.md](visualize_commands.md).
