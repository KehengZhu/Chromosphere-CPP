...
| `docs/roe_n1000_lower_chromosphere_sloshing_diagnosis.md` | Current for the mode and the `.faceflux` bug; measured under the Roe reference flux | The lower-chromosphere standing mode, the reflecting inner boundary, the mass-reservoir behaviour, and the untrusted `.faceflux` divergence. |
