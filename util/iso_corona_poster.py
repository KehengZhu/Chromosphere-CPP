...
Defaults: outputs/model_column/iso_corona.txt -> docs/posters/2026-07-11-shine/web/iso_corona_evolution.png
"""
import os
import sys
import numpy as np
...
def main():
    ...
    out_path = (sys.argv[2] if len(sys.argv) > 2
                else "docs/posters/2026-07-11-shine/web/iso_corona_evolution.png")
