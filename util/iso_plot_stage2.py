...
f=open("outputs/_archive/iso_stage2.txt");ns,neq=map(int,f.readline().split());h=np.array(list(map(float,f.readline().split())))
...
plt.tight_layout();plt.savefig("visualization/_archive/iso_stage2_evaporation.png",dpi=130)
...
print("saved visualization/_archive/iso_stage2_evaporation.png")
