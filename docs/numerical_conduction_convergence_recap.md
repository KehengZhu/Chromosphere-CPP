...
> `docs/local_mesh_scaled_numerical_conduction_recap.md` for the implementation and
> targeted validation.

Targeted follow-up to Result D of `docs/resolution_convergence_scan_recap.md`. Only the boxed question was tested; nothing was extended.
...
- `docs/numerical_conduction_convergence_recap.md` — this file
