...
- `docs/studies/eos-ionization/ionization_recombination_formulation.md` §2.2 + writeup `main.tex`/`paper.tex` §3.1 — document the C7-context inversion and the equilibrium/NEQ split.
