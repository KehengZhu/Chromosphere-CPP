...
```text
 M AGENTS.md
 M CLAUDE.md
 M docs/studies/conduction/local_mesh_scaled_numerical_conduction_recap.md
...
docs/studies/validation/long_run_output_and_cfl_validation.md   (new)  this document
```
