...
- **Isotropic numerical diffusion** (`Grid::numerical_diffusivity_per_length`, Pandey 2024) folded into the Stage-D face conductivities as `chi_num,f = C_num*ds_face`, `K_num,f = chi_num,f*C`; `model_c7` sets `C_num=2000 m/s` before scenario multipliers.
